...
// RVTEST_SIGUPD_V(sigptr, linkreg, tempreg, vtmp, mtmp, offset, vreg, strptr)
    ...
    2:                                                                                  \
        ...
        beqz        _MASK_REG, 6f            ;    /* skip if no mask */                 \
        vid.v       _VTMP                    ;                                          \
