...
covergroup SscofpmfU_cg with function sample(ins_t ins);
    ...
    hpm_csr_target: coverpoint ins.current.insn[31:20] {
            ...
            bins mhpmeventh[] = {CSR_MHPMEVENTH3,  CSR_MHPMEVENT4,  CSR_MHPMEVENT5,
    ...
    cp_lcofi:                  cross priv_mode_u, lcofi_ip, lcofi_ie, lcofi_mideleg, lcofi_mideleg, mstatus_mie_clear, mstatus_sie_set;
