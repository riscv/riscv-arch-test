...
The RVA23 processor certification requires compliance with the https://riscv.github.io/riscv-isa-manual/snapshot/spec/#_rva23_profiles[RVA23 Profiles], which is comprised of the RVA23S64 and RVA23U64 profiles. As described in these profile specifications,
