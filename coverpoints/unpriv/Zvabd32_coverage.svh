...
`define COVER_ZVABD32
`define COVER_ZVABDCUSTOM32
`ifdef UDB_ELEN_32
...
`endif
covergroup Zvabd32_vabs_v_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
function void zvabd32_sample(int hart, int issue, ins_t ins);
