= RVI20 Certification Requirements Document (rev 1.2)
...
| April 3, 2026
| 1.2
a| * Updates to match formatting of MC100 CRD (e.g., parameter appendix lists all parameters, not just IN-SCOPE.)
