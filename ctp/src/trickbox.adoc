...
|RVMODEL_CLEAR_MEXT_INT|Clears the Machine External Interrupt (mip.MEIP = 0)
|RVMODEL_SET_MTIMER_INT|Sets the Machine Timer Interrupt (mip.MTIP = 1, if supported)
|RVMODEL_CLEAR_MTIMER_INT|Clears the Machine Timer Interrupt (mip.MTIP = 0)
...
|RVMODEL_CLEAR_MSW_INT|Clears the Machine Software Interrupt (mip.MSIP = 0)
|RVMODEL_SET_SEXT_INT|Sets the Supervisor External Interrupt (sip.SEIP = 1, if supported)
|RVMODEL_CLEAR_SEXT_INT|Clears the Supervisor External Interrupt (sip.SEIP = 0)
|RVMODEL_SET_STIMER_INT|Sets the Supervisor Timer Interrupt (sip.STIP = 1, if supported)
|RVMODEL_CLEAR_STIMER_INT|Clears the Supervisor Timer Interrupt (sip.STIP = 0)
...
|RVMODEL_CLEAR_SSW_INT|Clears the Supervisor Software Interrupt (mip.SSIP = 0)
