...
Vector bit manipulation extensions include Zvabd, Zvbb, and Zvbc.

==== Zvabd Vector Absolute Value and Absolute Difference Extension
[[t-Zvabd-coverpoints]]
.Zvabd Instruction Coverpoints
// include::{testplansdir}/Zvabd.adoc[]
