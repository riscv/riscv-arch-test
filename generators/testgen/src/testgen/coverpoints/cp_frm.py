...
def make_frm(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for frm_mode in frm_modes:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{frm_mode}", coverpoint)
