...
include::{privtestplansdir}/Sm.adoc[]
...
include::{privtestplansdir}/S.adoc[]
...
include::{privtestplansdir}/U.adoc[]
...
include::{privtestplansdir}/SmF.adoc[]
...
include::{privtestplansdir}/UF.adoc[]
...
include::{privtestplansdir}/Zkr.adoc[]
