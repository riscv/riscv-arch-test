...
def _generate_wrs_sto_timeout_tests(test_data: TestData) -> list[str]:
    ...
    lines.extend(_wrs_timeout_helper(test_data, ["M"], coverpoint, covergroup))
    return lines
...
def _generate_wrs_resume_tests(test_data: TestData) -> list[str]:
    ...
    lines.extend(_wrs_resume_helper(test_data, "M", covergroup))
    return lines
...
def _generate_wrs_no_mie_tests(test_data: TestData) -> list[str]:
    ...
    lines.extend(_wrs_no_mie_helper(test_data, "M", covergroup))
    return lines
