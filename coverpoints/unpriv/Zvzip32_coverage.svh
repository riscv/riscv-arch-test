...
`define COVER_ZVZIP32
`define COVER_ZVZIPCUSTOM32
`ifdef UDB_ELEN_32
...
`endif
covergroup Zvzip32_vpaire_vv_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
covergroup Zvzip32_vpairo_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvzip32_vunzipe_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip32_vunzipo_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip32_vzip_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
function void zvzip32_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 2 ||
        ...
        case (traceDataQ[hart][issue][0].inst_name)
            "vpaire.vv"     : begin
                Zvzip32_vpaire_vv_cg.sample(ins);
            end
            "vpairo.vv"     : begin
                Zvzip32_vpairo_vv_cg.sample(ins);
            end
            "vunzipe.v"     : begin
                Zvzip32_vunzipe_v_cg.sample(ins);
            end
            "vunzipo.v"     : begin
                Zvzip32_vunzipo_v_cg.sample(ins);
            end
            "vzip.vv"     : begin
                Zvzip32_vzip_vv_cg.sample(ins);
            end
        endcase
    end
endfunction
