...
`define COVER_EXCEPTIONSSVZALRSCSM
covergroup ExceptionsSvZalrscSm_cg with function sample(ins_t ins);
...
function void exceptionssvzalrscsm_sample(int hart, int issue, ins_t ins);
    ExceptionsSvZalrscSm_cg.sample(ins);
endfunction
