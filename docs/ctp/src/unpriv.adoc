...
|cp_fpr_hazard|4|Floating-point register hazard detection: RAW, WAR, WAW, and no hazard. [TODO: this might change when hazards are updated]
...
|Memory Dest||sw, amoswap.w (Zaamo)||||fsw|vse32.v|
