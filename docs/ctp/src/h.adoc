...
==== InterruptsHSm and InterruptsH Hypervisor Interrupts
...
priorities and delivery to HS-mode and VS-mode.  Guest external interrupts need the optional
RVMODEL_SET_GUEST_EXT_INT hook, which the Sail configurations define.
