...
==== ZicntrSm Machine-Mode Counters

[[t-ZicntrSm-coverpoints]]
.ZicntrSm Coverpoints
,===
//include::{testplansdir}/ZicntrSm.adoc[]
,===
https://docs.google.com/spreadsheets/d/1wfMzXqXOjg_ND9BhFxChQCi9s4BwsZREPtGS8O1q4tM/edit?gid=0#gid=0[Google Sheet Testplan]

*** move this to Sm because these counters are mandatory
