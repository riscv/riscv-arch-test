...
TODO: Discuss one vs. many reference models. RISC-V International has blessed https://github.com/riscv/sail-riscv[RISC-V Sail] as the golden RISC-V model, so RISC-V Sail is used as the reference model.
...
Nevertheless, the RISC-V Sail model is making rapid progress and is aiming to fully implement the ratified RVA23 profile, read a UDB configuration, and support at least the most reasonable behaviors in time for certification.
