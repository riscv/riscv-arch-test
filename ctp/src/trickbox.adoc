...
|RVMODEL_SET_VTIMER_INT_SOON|Cause the Virtual Supervisor Timer Interrupt to rise soon, but not immediately.
...
|ACCESS_FAULT_ADDRESS|The base address of a region of at least 128 bytes that causes an access fault when read or written. This is used to test exceptions.
|===
