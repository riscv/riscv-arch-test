...
// machine external interrupts are not generated by an interrupt controller, so the macros are
// left undefined and UDB_MEI_INTR_IMPL stays clear (see tests/env/check_defines.h)
