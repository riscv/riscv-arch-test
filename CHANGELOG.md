...
- Updated \_\_MODE\_\_\()trap_sig_sv, replaced an LA(rvtest_trap_sig) by calculating initial_Xtrap_sigptr + (Mtrap_sigptr-initial_Mtrap-sigptr)
- Similar changes are made in chk\_\_\_MODE\_\_\()trapsig_overrun macro.
...
2021-03-26 Duncan Graham <info@imperas.com> - Added new K Crypto (scalar) (0.8.1) tests from Imperas
