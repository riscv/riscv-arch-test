...
def make_NaNBox(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    tc = format_single_test(instr_name, instr_type, test_data, params, desc, "NaNBox", coverpoint)
