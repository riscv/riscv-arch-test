...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    reserved : coverpoint ins.current.insn { // reserved but not illegal
        ...
        wildcard bins reserved_fencei_rd    = {32'b000000000000_00000_001_?????_0001111} with (item[11:7] != 5'b00000); // fence.i with reserved rd
        wildcard bins reserved_fencei_rs1   = {32'b000000000000_?????_001_00000_0001111} with (item[19:15] != 5'b00000); // fence.i with reserved rs1
        wildcard bins reserved_fencei_imm12 = {32'b????????????_00000_001_00000_0001111} with (item[31:20] != 12'b0); // fence.i with reserved imm12        wildcard bins reserved_rm5_fmadd = {32'b???????_?????_?????_101_?????_1000011}; // fma with reserved rm
