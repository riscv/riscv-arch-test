...
@add_instruction_formatter("VLSFF", vlus_config)
...
@add_instruction_formatter("VLSEGFF", vlseg_config)
...
def format_vlseg_like_type(
    ...
    assert eew is not None, f"Could not extract an EEW from VLUS-type instruction {instr_str}"
