...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    compressed00 : coverpoint ins.current.insn[15:2] iff (ins.current.insn[1:0] == 2'b00) {
        ...
        ignore_bins c_sb  = {[14'b10001000000000:14'b10000111111111]}; // c.sb throw exceptions for bad addresses
    ...
    compressed10 : coverpoint ins.current.insn[15:2] iff (ins.current.insn[1:0] == 2'b10) {
        ...
        ignore_bins c_jr      = {[14'b1000_0000000001:14'b1000_1111111111]};   // c.jr causes test program to go to random place.  This ignore excludes some instructions with insn[7:2] != 00000 that ought to be covered, but the tests run those instructions anyway.
        ...
        ignore_bins c_swsp[]  = {[14'b110_00000000000:14'b110_11111111111]}; // c.lssp throws exceptions for bad addresses.
