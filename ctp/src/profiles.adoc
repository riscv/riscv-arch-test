...
|Zicclsm|Misaligned Loads / Stores|<<t-Zicclsm-coverpoints>>|o|o|x|x|x
...
|ZicntrSm|Machine Counters|<<t-ZicntrSm-coverpoints>>|o|x|x|x|x
...
8+^|Strict
|SsstrictSm|Machine Strict (unratified)|<<t-SsstrictSm-coverpoints>>|||o|o|o
...
|E|Embedded 16 Regs|<<t-E-normative_rules>>|||||
