...
covergroup SmnpmU_cg with function sample(ins_t ins);
    ...
    menvcfg_pmm: coverpoint get_csr_val(ins.hart, ins.issue, `SAMPLE_CURRENT, "menvcfg", "pmm") {
        bins disabled_00 = {2'b00};
    ...
    cp_mask_priv_mode_only_read: cross priv_mode_u, menvcfg_pmm, read_instr ;
    cp_pm_misaligned_half_write: cross priv_mode_u, menvcfg_pmm, misalign_write_instr_half, misaligned_half ;
    cp_pm_misaligned_half_read: cross priv_mode_u, menvcfg_pmm, misalign_read_instr_half, misaligned_half ;
    cp_pm_misaligned_word_write: cross priv_mode_u, menvcfg_pmm, misalign_write_instr_word, misaligned_word ;
    cp_pm_misaligned_word_read: cross priv_mode_u, menvcfg_pmm, misalign_read_instr_word,  misaligned_word ;
    cp_pm_misaligned_double_write: cross priv_mode_u, menvcfg_pmm, misalign_write_instr_double, misaligned_double ;
    cp_pm_misaligned_double_read: cross priv_mode_u, menvcfg_pmm, misalign_read_instr_double, misaligned_double ;
