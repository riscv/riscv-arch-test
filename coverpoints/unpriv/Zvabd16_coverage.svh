...
`define COVER_ZVABD16
`define COVER_ZVABDCUSTOM16
`ifdef UDB_ELEN_16
...
`endif
covergroup Zvabd16_vabd_vv_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
covergroup Zvabd16_vabdu_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vd_vs1
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvabd16_vabs_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vd_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvabd16_vwabda_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvabd16_vwabdau_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
function void zvabd16_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 1 ||
        ...
        case (traceDataQ[hart][issue][0].inst_name)
            "vabd.vv"     : begin
                Zvabd16_vabd_vv_cg.sample(ins);
            end
            "vabdu.vv"     : begin
                Zvabd16_vabdu_vv_cg.sample(ins);
            end
            "vabs.v"     : begin
                Zvabd16_vabs_v_cg.sample(ins);
            end
            "vwabda.vv"     : begin
                Zvabd16_vwabda_vv_cg.sample(ins);
            end
            "vwabdau.vv"     : begin
                Zvabd16_vwabdau_vv_cg.sample(ins);
            end
        endcase
    end
endfunction
