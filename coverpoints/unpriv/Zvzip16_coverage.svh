...
`define COVER_ZVZIP16
`define COVER_ZVZIPCUSTOM16
`ifdef UDB_ELEN_16
...
`endif
covergroup Zvzip16_vpaire_vv_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
covergroup Zvzip16_vpairo_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvzip16_vunzipe_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip16_vunzipo_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip16_vzip_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
function void zvzip16_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 1 ||
        ...
        case (traceDataQ[hart][issue][0].inst_name)
            "vpaire.vv"     : begin
                Zvzip16_vpaire_vv_cg.sample(ins);
            end
            "vpairo.vv"     : begin
                Zvzip16_vpairo_vv_cg.sample(ins);
            end
            "vunzipe.v"     : begin
                Zvzip16_vunzipe_v_cg.sample(ins);
            end
            "vunzipo.v"     : begin
                Zvzip16_vunzipo_v_cg.sample(ins);
            end
            "vzip.vv"     : begin
                Zvzip16_vzip_vv_cg.sample(ins);
            end
        endcase
    end
endfunction
