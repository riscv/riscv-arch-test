...
@add_instruction_formatter("L", required_params={"rd", "rs1", "rs2", "rs2val", "immval"}, imm_bits=12, imm_signed=True)
def format_l_type(
    ...
    setup.append(f"SREG x{params.rs2}, {params.immval}(x{params.rs1}) # store test value to memory")
    test = [
