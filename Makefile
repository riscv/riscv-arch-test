...
EXTENSIONS  ?=
EXCLUDE_EXTENSIONS ?= Sm,S,Zalrsc,Zacas,ZacasZabha,InterruptsSm,PMPSm,PMPmisaligned,PMPZalrsc,ExceptionsZalrsc,ExceptionsZicboU,ExceptionsZicboS,Sv,SvPMP,SvaduPMP,Svpbmt,Svnapot,SvZicbo,Svinval,ExceptionsZaamo,ExceptionsSvZaamo,ExceptionsSvZalrsc#Sm,S,InterruptsSm,InterruptsS,InterruptsU,Sv,SvaduPMP,SvPMP,SvPMPZicbo,Svade,Svinval,SvZicbo,Svnapot,Svpbmt,ExceptionsSvZalrsc,ExceptionsSvZaamo,ExceptionsZalrsc,ExceptionsZaamo,PMPZca,PMPS,PMPU #PMPF,PMPS,PMPSm,PMPU,PMPZaamo,PMPZalrsc,PMPZca,PMPZicbo,PMPmisaligned,,
