...
riscv-software-src.github.io/riscv-unified-db/pdfs/RVI20-32-CRD.pdf
...
if these rules can be tested by coverpoints that execute the instruction or access the CSR, then no other coverpoints are needed.  For example, a normative rule that an add instruction has op = 0110011, funct3 = 000, and funct7 = 0000000 is tested by the ordinary coverpoints that add exercise the add instruction.
