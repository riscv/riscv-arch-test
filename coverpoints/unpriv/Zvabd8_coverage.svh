...
`endif
covergroup Zvabd8_vabd_vv_cg with function sample(ins_t ins);
    ...
    cp_asm_count : coverpoint ins.ins_str == "vabd.vv"  iff (ins.trap == 0 )  {
...
endgroup
// ---------------------
covergroup Zvabd8_vabdu_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vd_vs1
    //////////////////////////////////////////////////////////////////////////////////
    ...
    cp_asm_count : coverpoint ins.ins_str == "vabdu.vv"  iff (ins.trap == 0 )  {
        // Number of times instruction is executed
        bins count[]  = {1};
    }
...
endgroup
// ---------------------
covergroup Zvabd8_vabs_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vd_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvabd8_vwabda_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
    ...
    cp_asm_count : coverpoint ins.ins_str == "vwabda.vv"  iff (ins.trap == 0 )  {
        // Number of times instruction is executed
        bins count[]  = {1};
    }
...
endgroup
// ---------------------
covergroup Zvabd8_vwabdau_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
    ...
    cp_asm_count : coverpoint ins.ins_str == "vwabdau.vv"  iff (ins.trap == 0 )  {
        // Number of times instruction is executed
        bins count[]  = {1};
    }
...
endgroup
// ---------------------
function void zvabd8_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 0 ||
        ...
        case (traceDataQ[hart][issue][0].inst_name)
            "vabd.vv"     : begin
                Zvabd8_vabd_vv_cg.sample(ins);
            end
            "vabdu.vv"     : begin
                Zvabd8_vabdu_vv_cg.sample(ins);
            end
            "vabs.v"     : begin
                Zvabd8_vabs_v_cg.sample(ins);
            end
            "vwabda.vv"     : begin
                Zvabd8_vwabda_vv_cg.sample(ins);
            end
            "vwabdau.vv"     : begin
                Zvabd8_vwabdau_vv_cg.sample(ins);
            end
        endcase
    end
endfunction
