...
def make_fs1_badNB(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for edge_val in edges:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{edge_val:#x}", coverpoint)
...
def make_fs2_badNB(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
...
def make_fs3_badNB(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
