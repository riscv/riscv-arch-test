...
==== SvH_CBO Hypervisor VirtMem + Cache Block Operations

[[t-SvH_CBO-coverpoints]]
.SvH_CBO Coverpoints
,===
//include::{testplansdir}/SvH_CBO.adoc[]
,===
