...
def make_fd(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for fd in fd_regs:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{fd}", coverpoint)
...
def make_fs1(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for fs1 in fs1_regs:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{fs1}", coverpoint)
        test_cases.append(tc)
        return_test_regs(test_data, params)
...
def make_fs2(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for fs2 in fs2_regs:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{fs2}", coverpoint)
        test_cases.append(tc)
        return_test_regs(test_data, params)
...
def make_fs3(instr_name: str, instr_type: str, coverpoint: str, test_data: TestData) -> list[TestCase]:
    ...
    for fs3 in fs3_regs:
        ...
        tc = format_single_test(instr_name, instr_type, test_data, params, desc, f"b{fs3}", coverpoint)
        test_cases.append(tc)
        return_test_regs(test_data, params)
