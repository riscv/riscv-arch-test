...
covergroup SmnpmS_cg with function sample(ins_t ins);
    ...
    stval_written: coverpoint get_csr_val(ins.hart, ins.issue, `SAMPLE_AFTER, "stval", "value") {
    bins nonzero = {[1:$]};
    }

    cp_pmlen_masking_write: cross priv_mode_s, menvcfg_pmm, mode_satp,  write_instr;
    cp_pmlen_masking_read: cross priv_mode_s, menvcfg_pmm, mode_satp, read_instr;
    `ifdef ZAAMO_SUPPORTED
    cp_effective_address_explicit_write: cross priv_mode_s, menvcfg_pmm,mode_satp, write_instr, amo_op ;
    cp_effective_address_explicit_read: cross priv_mode_s, menvcfg_pmm,mode_satp, read_instr, amo_op ;
    `endif
    cp_effective_address_fetch: cross priv_mode_s, menvcfg_pmm,mode_satp_pa, exec_op ;
    cp_mask_priv_mode_only_write: cross priv_mode_s, menvcfg_pmm, mode_satp,   write_instr; //still working on xlen pattern bins.
    cp_mask_priv_mode_only_read: cross priv_mode_s, menvcfg_pmm, mode_satp,  read_instr ;
    cp_pm_mxr_disable_write: cross priv_mode_s, menvcfg_pmm, mxr_bit, mode_satp_va,  write_instr ;
    cp_pm_mxr_disable_read: cross priv_mode_s, menvcfg_pmm, mxr_bit, mode_satp_va, read_instr ;
    cp_pm_misaligned_half_write: cross priv_mode_s, menvcfg_pmm, mode_satp, misalign_write_instr_half, misaligned_half ;
    cp_pm_misaligned_half_read: cross priv_mode_s, menvcfg_pmm, mode_satp,  misalign_read_instr_half, misaligned_half ;
    cp_pm_misaligned_word_write: cross priv_mode_s, menvcfg_pmm,mode_satp,  misalign_write_instr_word,  misaligned_word ;
    cp_pm_misaligned_word_read: cross priv_mode_s, menvcfg_pmm,mode_satp, misalign_read_instr_word,  misaligned_word ;
    cp_pm_misaligned_double_write: cross priv_mode_s, menvcfg_pmm, mode_satp, misalign_write_instr_double, misaligned_double ;
    cp_pm_misaligned_double_read: cross priv_mode_s, menvcfg_pmm, mode_satp, misalign_read_instr_double, misaligned_double ;
    cp_pm_csr_software_access_write: cross priv_mode_s, menvcfg_pmm, csr_write_op, csr_software_target;
    cp_pm_csr_software_access_read: cross priv_mode_s, menvcfg_pmm,  csr_read_op, csr_software_target;
    cp_hardware_csr_writes_read:  cross priv_mode_s, menvcfg_pmm, read_instr,  stval_written;
    cp_hardware_csr_writes_write: cross priv_mode_s, menvcfg_pmm, write_instr, stval_written;
