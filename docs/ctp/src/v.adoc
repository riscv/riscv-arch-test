...
TODO: Re-evaluate whether the hardcoded skips / commented generation lines for these tests can be removed now that the referenced sail-riscv PR/issue are closed.
