...
#   Quote: "bit [31:0] mem_mailbox = 32'hD0580000;"
...
#   Quote: "$display(\"[%0t ns] TEST_PASSED\",$time); ... $finish;"
...
#   Quote: "$display(\"[%0t ns] TEST_FAILED\",$time); ... $fatal;"
...
# Not defined: VeeR EL2 reports out-of-window accesses as either a misaligned or an
...
#   https://github.com/chipsalliance/Cores-VeeR-EL2/blob/925f3a34/docs/source/memory-map.md#L201
...
# VeeR EL2 has no mtime/mtimecmp: the PRM states the SoC must supply them, and the
# testbench does not.  Quote: the standard registers section notes mtime/mtimecmp are
# expected to be provided by the SoC, not the core.  Leaving RVMODEL_MTIME_ADDRESS undefined disables all machine
...
# VeeR EL2 has M and U mode but no S-mode; these cannot occur but must be defined.
