...
covergroup Svpbmt_cg with function sample(ins_t ins);
    ...
    nonleaf_PTE_pbmt_i: coverpoint ins.current.pte_i[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????00?00001};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????00?00001};
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????00?00001};
    }
    nonleaf_PTE_pbmt_d: coverpoint ins.current.pte_d[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????00?00001};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????00?00001};
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????00?00001};
    }

    leaf_PTE_pbmt_s_i: coverpoint ins.current.pte_i[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????11?01111};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????11?01111};
    }
    leaf_PTE_pbmt_u_i: coverpoint ins.current.pte_i[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????11?11111};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????11?11111};
    }
    leaf_PTE_pbmt_s_d: coverpoint ins.current.pte_d[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????11?01111};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????11?01111};
    }
    leaf_PTE_pbmt_u_d: coverpoint ins.current.pte_d[63:0] {
        wildcard bins pbmt_1 = {64'b?01?????????????????????????????????????????????????????11?11111};
        wildcard bins pbmt_2 = {64'b?10?????????????????????????????????????????????????????11?11111};
    }

    leaf_PTE_pbmt_res_s_i: coverpoint ins.current.pte_i[63:0] {
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????11?01111};
    }
    leaf_PTE_pbmt_res_u_i: coverpoint ins.current.pte_i[63:0] {
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????11?11111};
    }
    leaf_PTE_pbmt_res_s_d: coverpoint ins.current.pte_d[63:0] {
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????11?01111};
    }
    leaf_PTE_pbmt_res_u_d: coverpoint ins.current.pte_d[63:0] {
        wildcard bins pbmt_3 = {64'b?11?????????????????????????????????????????????????????11?11111};
    }
