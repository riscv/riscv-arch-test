...
`define COVER_ZVZIP64
`define COVER_ZVZIPCUSTOM64
`ifdef UDB_ELEN_64
...
`endif
covergroup Zvzip64_vpaire_vv_cg with function sample(ins_t ins);
...
endgroup
// ---------------------
covergroup Zvzip64_vpairo_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
covergroup Zvzip64_vunzipe_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip64_vunzipo_v_cg with function sample(ins_t ins);
    option.per_instance = 0;
...
endgroup
// ---------------------
covergroup Zvzip64_vzip_vv_cg with function sample(ins_t ins);
    option.per_instance = 0;
    //////////////////////////////////////////////////////////////////////////////////
    // cmp_vs1_vs2
    //////////////////////////////////////////////////////////////////////////////////
...
endgroup
// ---------------------
function void zvzip64_sample(int hart, int issue, ins_t ins);
    ...
    if (get_csr_val(hart, issue, `SAMPLE_BEFORE, "vtype", "vsew") == 3 ||
        ...
        case (traceDataQ[hart][issue][0].inst_name)
            "vpaire.vv"     : begin
                Zvzip64_vpaire_vv_cg.sample(ins);
            end
            "vpairo.vv"     : begin
                Zvzip64_vpairo_vv_cg.sample(ins);
            end
            "vunzipe.v"     : begin
                Zvzip64_vunzipe_v_cg.sample(ins);
            end
            "vunzipo.v"     : begin
                Zvzip64_vunzipo_v_cg.sample(ins);
            end
            "vzip.vv"     : begin
                Zvzip64_vzip_vv_cg.sample(ins);
            end
        endcase
    end
endfunction
