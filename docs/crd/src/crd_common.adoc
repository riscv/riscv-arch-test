...
| REQ-<ID> | A requirement that applies to both RV32 and RV64
| REQ32-<ID> | A requirement that applies to only RV32
| REQ64-<ID> | A requirement that applies to only RV64
|===
