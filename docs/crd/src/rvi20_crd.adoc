...
include::../build/param-appendix-adoc-includes/HPM_COUNTER_SZ.adoc[]
include::../build/param-appendix-adoc-includes/LRSC_RESERVATION_STRATEGY.adoc[]
include::../build/param-appendix-adoc-includes/MISALIGNED_LDST_HW_SUPPORT.adoc[]
include::../build/param-appendix-adoc-includes/TIME_CSR_HW_SUPPORT.adoc[]
|===
