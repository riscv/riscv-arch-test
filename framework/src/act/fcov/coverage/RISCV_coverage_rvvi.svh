...
function void save_rvvi_data(bit trap, int hart, int issue, string disass);
  ...
  rvviData.vs_pte_i = this.rvvi.vs_pte_i[hart][issue];
  rvviData.vs_pte_d = this.rvvi.vs_pte_d[hart][issue];
  rvviData.g_pte_i = this.rvvi.g_pte_i[hart][issue];
  rvviData.g_pte_d = this.rvvi.g_pte_d[hart][issue];
