...
covergroup Ssstateen_cg with function sample(ins_t ins);
    ...
    csr_walk: coverpoint ins.current.rs1_val {
            ...
            //wildcard bins walking1_1  = {64'b??????????????????????????????????????????????????????????????1?}; // Uncomment Zfinx is supported
            //wildcard bins walking1_2  = {64'b?????????????????????????????????????????????????????????????1??}; // Uncomment Zcmt is supported
    ...
    csr_walk: coverpoint ins.current.csr[ins.current.insn[31:20]] {
            ...
            //wildcard bins walking1_1  = {32'b??????????????????????????????1?}; // Uncomment when Zfinx is supported
            //wildcard bins walking1_2  = {32'b?????????????????????????????1??}; // Uncomment when Zcmt is supported
