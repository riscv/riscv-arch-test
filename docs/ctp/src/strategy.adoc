...
The <<abstraction-layer,certification framework>> requires a fully-configured UDB description of the DUT and RVMODEL macros for the DUT.
...
* Configuration files for other optional simulators, such as Spike, https://github.com/openhwfoundation/cvw/blob/main/config/rv64gc/imperas.ic[ImperasFPM]
