...
The vector extension is huge.  The testplan is partitioned into three unprivileged portions discussed here, and two privileged portions (ExceptionsV, <<t-SsstrictV-coverpoints,SsstrictV>>) discussed in <<Vector Privileged Test Suites>>.
